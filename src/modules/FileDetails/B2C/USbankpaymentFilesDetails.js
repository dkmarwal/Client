						...
						>
							...
							<Box p={2}>
								...
								>
									<Box fontSize={16} width="40%">
										{" "}
										{t('componentData.paymentFileDetail.Records')}{" "}
									</Box>
									<Box fontSize={15} width="60%">
										{" "}
										{paymentFileData.TotalNoofRecord || "--"}
									</Box>
								</Box>
								<Box
									display="flex"
								...
								{paymentFileData.TotalNoOfPrePayee?
								<Box
									display="flex"
									justifyContent="space-between"
									pb={2}
								...
								>
									<Box fontSize={16} width="40%">
										{" "}
										{t('componentData.paymentFileDetail.preenrolement')}{" "}
									</Box>
									<Box fontSize={15} width="60%">
										{" "}
										<u
											...
											onClick={() => {
												this.props.history.push({
												  ...
												  state:{
													fileID: paymentFileData.FileID ?? null
												  }
												}                          
												);
											  }}
										>
											{paymentFileData.TotalNoOfPrePayee || 0} {t('componentData.paymentFileDetail.enrollments')} {" "}
										</u>
									</Box>
								</Box>:
								<></>}
								{paymentFileData.TotalNoOfPrePayeeException?
								<Box
									display="flex"
									justifyContent="space-between"
									pb={2}
								...
								>
									<Box fontSize={16} width="40%">
										{" "}
										{t('componentData.paymentFileDetail.Preenreception')}{" "}
									</Box>
									<Box fontSize={15} width="60%">
										{" "}
										{paymentFileData.TotalNoOfPrePayeeException|| "--"}
											...
											{CDMPaymentVal > 0 && (
												<li>
													<span onClick={() =>
														...
														{t('componentData.paymentFileDetail.BLANKPayer')}
													</span>
													<label onClick={() =>
														this.props.history.push(
															`${config.baseName}/payments/paymentDetails?FileID=${paymentFileData.FileID}&ProcessedStatusFilter=${paymentFileData.ProcessedStatusFilter}&AddFilter=1`
											...
											{nonCDMPaymentVal > 0 && (
												<li>
													<span onClick={() =>
														...
														{t('componentData.paymentFileDetail.FORCEPayer')}
													</span>
													<label onClick={() =>
														this.props.history.push(
															`${config.baseName}/payments/paymentDetails?FileID=${paymentFileData.FileID}&ProcessedStatusFilter=${paymentFileData.ProcessedStatusFilter}&AddFilter=2`
