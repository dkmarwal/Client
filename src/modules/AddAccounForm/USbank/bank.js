...
const USbankBank = (props) => {
  ...
  const paymentType = paymentMethods['USBankACH'];
      ...
      <Grid container>
        ...
        <Grid item xs={12} sm={6} className={classes.multitBox}>
          <TextField
            ...
            placeholder={t(
              'componentData.USbankBankDetail.BankRoutingCodePlaceholder'
            )}
