...
class PayeeVerificationScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {t("componentData.PayeeVerificationScreen.isJust")} 3{" "}
            ...
            >
              ...
              >
                <Box>
                  ...
                  >
                    {t(
                      "componentData.PayeeVerificationScreen.PayeeVerification"
                    )}
                  </Box>
                </Box>
                <Box>
                  ...
                  >
                    {t("componentData.PayeeVerificationScreen.PleaseHelp")}
                  </Box>
                </Box>
              </Box>
              ...
              >
                ...
                >
                  ...
                  >
                    {t("componentData.PayeeVerificationScreen.CustomerID")}
                  </Box>
                </Box>
                <Box
                  className={clsx(classes.formItemFormFieldContainer, {
                ...
                >
                  ...
                  >
                    {t("componentData.PayeeVerificationScreen.FirstName")}
                  </Box>
                  <Box
                    className={clsx(classes.formItemFormField, {
                      [classes.formItemformFieldMobile]: isMobileView === true,
                  ...
                  >
                    {t("componentData.PayeeVerificationScreen.LastName")}
                  </Box>
                </Box>
                <Box
                  className={clsx(classes.formItemLabelContainer, {
                    [classes.formItemFormFieldContainerMobile]:
                      isMobileView === true,
                  })}
                >
                  <Box>
                    {t("componentData.PayeeVerificationScreen.PhoneNumber")}
                  </Box>
                </Box>
                <Box
                  gridGap={"10px"}
                  height={isMobileView ? "40px" : "55px"}
                  className={clsx(classes.formItemFormFieldContainer, {
                    [classes.itemWidthCodeMobile]: isMobileView === true,
                  })}
                >
                  {"******8988".split("").map((el, i) => (
                    <>
                      {(i === 3 || i === 6) && (
                        <Box pt={isMobileView ? 0 : 1}>-</Box>
                      )}
                      <Box
                        className={clsx(classes.formItemFormField, {
                          [classes.formItemformFieldMobile]:
                            isMobileView === true,
                          [classes.itemWidthNumMobile]: isMobileView === true,
                          // [classes.itemWidthNum]: isMobileView == false,
                        })}
                      >
                        {el}
                      </Box>
                ...
                >
                  ...
                  >
                    {" "}
                    {t("componentData.PayeeVerificationScreen.EmailId")}
...
export default withTranslation()(
  withStyles(styles, { withTheme: true })(PayeeVerificationScreen)
);
