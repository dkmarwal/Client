...
import ZelleDisabled from '~/assets/icons/Zelle@1x.svg';
import clsx from 'clsx';

const ZelleDetails = (props) => {
  const {
    classes,
    t,
    tokenType,
    ...
    tokenStatus,
    bankName,
    paymentCode, DebitAccountNumber,
          ...
          <Grid container item alignItems="center">
            <Grid item xs={1} className={classes.iconImage}>
              <Tooltip title={paymentCode} arrow placement="right">
                <img
                  src={isPaymentCancelled ? ZelleDisabled : ZelleIcon}
                  alt={paymentCode}
                />
              </Tooltip>
            </Grid>
        ...
        <Paper square className={classes.boxSpace} elevation={2}>
          <Grid container item alignItems="center">
            ...
            <Grid className={classes.infoText} item xs={5}>
              ...
              >
                {t('componentData.paymentTransDetail.TokenType')}
              </Typography>
            </Grid>
            <Grid className={classes.infoText} item xs={6}>
              <Typography
          ...
          <Grid container item>
            ...
            <Grid className={classes.infoText} item xs={5}>
              ...
              >
                {t('componentData.paymentTransDetail.TokenValue')}
              </Typography>
            </Grid>
            <Grid className={classes.infoText} item xs={6}>
              <Typography
          ...
          <Grid container item>
            ...
            <Grid className={classes.infoText} item xs={5}>
              ...
              >
                {t('componentData.paymentTransDetail.TokenStatus')}
              </Typography>
            </Grid>
            <Grid className={classes.infoText} item xs={6}>
              <Typography
          ...
          <Grid container item>
            ...
            <Grid className={classes.infoText} item xs={5}>
              ...
              >
                {t('componentData.paymentTransDetail.BankName')}
              </Typography>
            </Grid>
            <Grid className={classes.infoText} item xs={6}>
              <Typography
...
export default withTranslation()(withStyles(styles)(ZelleDetails));
