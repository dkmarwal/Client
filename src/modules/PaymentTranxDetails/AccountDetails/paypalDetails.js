...
import PayPalDisabled from '~/assets/icons/Paypal@1x.svg';
          ...
          <Grid container item alignItems="center">
            <Grid item xs={1} className={classes.iconImage}>
              <Tooltip title={'paymentCode'} arrow placement="right">
                <img
                  src={isPaymentCancelled ? PayPalDisabled : PaypalIcon}
                  alt={paymentCode}
                />
              </Tooltip>
            </Grid>
...
export default withTranslation()(withStyles(styles)(PayPalDetails));
