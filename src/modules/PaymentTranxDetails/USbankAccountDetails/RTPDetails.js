...
import RTPDisabledIcon from '~/assets/icons/USbank/RTP_icon@1x.svg';
import clsx from 'clsx';

const RTPDetails = (props) => {
  const {
    classes,
    t,
    PaymentType,
        ...
        <Paper square className={classes.boxSpace} elevation={2}>
          <Grid container item alignItems="center">
            <Grid item xs={1} className={classes.iconImage}>
              <Tooltip title={'RTP'} arrow placement="right">
                <img
                  src={isPaymentCancelled ? RTPDisabledIcon : RTPIcon}
                  alt={PaymentType}
                />
              </Tooltip>
            </Grid>
...
export default withTranslation()(withStyles(styles)(RTPDetails));
