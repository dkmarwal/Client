...
const DigitalPlasticDetails = (props) => {
  const {
    classes,
    t,
    PayeeName,
        ...
        <Paper square className={classes.boxSpace} elevation={2}>
          <Grid container item alignItems="center">
            ...
            <Grid className={classes.infoText} item xs={5}>
              ...
              >
                {t('componentData.paymentTransDetail.FundingCardId')}
              </Typography>
            </Grid>
          ...
          <Grid container item>
            ...
            <Grid className={classes.infoText} item xs={5}>
              ...
              >
                {t('componentData.paymentTransDetail.FundingCardPasscode')}
              </Typography>
            </Grid>
            <Grid className={classes.infoText} item xs={6}>
              <Typography
...
export default withTranslation()(withStyles(styles)(DigitalPlasticDetails));
