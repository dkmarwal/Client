...
import CheckDisabled from '~/assets/icons/check_icon@1x.svg';
          ...
          <Grid container item alignItems="center">
            <Grid item xs={1} className={classes.iconImage}>
              <Tooltip title={paymentCode} arrow placement="right">
                <img
                  src={isPaymentCancelled ? CheckDisabled : CheckIcon}
                  alt={paymentCode}
                />
              </Tooltip>
            </Grid>
...
export default withTranslation()(withStyles(styles)(CheckDetails));
