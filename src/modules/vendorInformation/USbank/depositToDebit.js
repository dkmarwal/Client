            ...
            <Grid item xs={12} className={classes.paymentTitleOuterGrid}>
              <Grid className={classes.paymentTitleOuterCont}>
                ...
                <Typography
                  ...
                  style={{ float: "left" }}
                >
                  {t(`componentData.vendorInfo.DepositToDebit`)}
                </Typography>
              </Grid>
              <Grid>
              ...
              <Grid container direction="row" style={{ marginBottom: "8px" }}>
                ...
                <Grid item xs={4}>
                  <Typography className={classes.infoValue}>
                    {consumerDebitCardDetails?.debitCardNumber ?? ""}
                  </Typography>
                </Grid>
                ...
                <Grid item xs={4}>
                  <Typography className={classes.infoValue}>
                    {consumerDebitCardDetails?.expiryDate ?? ""}
                  </Typography>
                </Grid>
...
export default withTranslation()(withStyles(styles)(DepositToDebit));
