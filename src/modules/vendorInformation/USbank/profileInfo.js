...
import { PayeeType,PayeeTypeName } from "~/config/entityTypes";
            ...
            <Grid container>
              ...
              <Grid item xs={6}>
                <Box my={1}>
                  <Grid container item xs={12} spacing={2}>
                    ...
                    <Grid item xs={6} className={classes.value}>
                      {data.payeeType===PayeeTypeName["Business"]?
                      `${data.companyName?? ""}` :
              ...
              <Grid item xs={6}>
                <Box my={1}>
                  <Grid container item xs={12} spacing={2}>
                    ...
                    {data.phoneNumber &&
                    <Grid item xs={8} className={classes.value}>
                      {`${data.phoneCountryCode && data.phoneCountryCode != '91' ? data.phoneCountryCode : '+1'}${
                        data.phoneNumber ?? ""
                      }`}
                    </Grid>}
                  </Grid>
              ...
              <Grid item xs={6}>
                <Box my={1}>
                  <Grid container item xs={12} spacing={2}>
                    <Grid item xs={4} className={classes.key}>
                      {t("componentData.profileInfo.PayeeType")}
                    </Grid>
                    <Grid item xs={6} className={classes.value}>
                      {data.payeeType}
                    </Grid>
