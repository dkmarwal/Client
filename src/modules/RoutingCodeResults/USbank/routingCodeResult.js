    ...
    <>
      ...
      {totalCount ? (
        <Box pb={2} textAlign={"center"}>
          <Typography className={classes.bankSearchSubHeading}>
            {t("componentData.routingCodeResult.text.bankResult", {
              totalCount,
            })}
          </Typography>
        </Box>
          ...
          <TableHead>
            <TableRow className={classes.bankSearchTable}>
              ...
              <TableCell style={{ width: "300px" }}>
                {t("componentData.routingCodeResult.tableHeader.bankName")}
              </TableCell>
              <TableCell style={{ minWidth: "100px" }}>
                {t("componentData.routingCodeResult.tableHeader.routingNumber")}
              </TableCell>
              <TableCell style={{ width: "160px" }}>
                {t("componentData.routingCodeResult.tableHeader.city")}
              </TableCell>
              <TableCell style={{ width: "160px" }}>
                {t("componentData.routingCodeResult.tableHeader.state")}
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
                ...
                <TableCell colSpan={6} style={{ border: "none" }}>
                  <Box display="block" textAlign="center" py={3} width="100%">
                    ...
                    <Box py={2} style={{ color: "#9d9d9d", fontSize: "12px" }}>
                      {t("componentData.routingCodeResult.text.noDataFound")}
                    </Box>
                  </Box>
                </TableCell>
              </TableRow>
        ...
        >
          <TablePagination
            ...
            labelDisplayedRows={({ from, to, count }) =>
              t("componentData.routingCodeResult.text.labelDisplayedRows", {
                from: from,
                to: to,
                count: count,
              })
      ...
      >
        ...
        >
          ...
          >
            {t("componentData.routingCodeResult.button.back")}
          </Button>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          >
            {t("componentData.routingCodeResult.button.select")}
          </Button>
        </Grid>
      </Grid>
    </>
...
export default withTranslation()(
  connect((state) => ({ ...state.user, ...state.payment  }))(RoutingCodeSearchResults)
);