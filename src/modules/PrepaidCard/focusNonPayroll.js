...
class FocusNonPayroll extends Component {
  ...
  getPrepaidCardAPIData = () => {
    ...
    this.props
      .dispatch(fetchUSBankPrepaidCardData(Id, showParentData))
      .then((response) => {
    ...
    if (valid) {
      ...
      if (this.state.focusNonPayrollData.uploadFile?.length) {
        if (this.state.focusNonPayrollData.uploadFile.length > 5) {
          tempProps.setVariant('error');
          tempProps.setErrorText(
          ...
          <Grid container justifyContent='center' spacing={2}>
            <Grid container justifyContent='flex-start'>
              ...
              <FocusNonPayrollACHAccount
                ...
                reliaFocusParams={
                  this.props.USBankPayment?.reliaFocusCardParams
                }
              ...
              <Grid item xs={12} sm={6} className={classes.gridItem}>
                <Box mx={1} my={2} style={{ display: 'flex' }}>
                  <Grid item sm={6} xs={6}>
                    <Typography>
                      {t(
                        'componentData.USBankPrepaidCard.uploadDisclosureForm'
                      )}
                    </Typography>
                  </Grid>
                  <Grid item sm={6} xs={6}>
                        ...
                        <Grid item sm={10} xs={10}>
                          {this.state.cardImageUploading ? (
                            ...
                            >
                              ...
                              <Typography style={{ color: '#008CE6' }}>
                                {t(
                                  'componentData.USBankPrepaidCard.chooseFile'
                                )}
                              </Typography>
                            </label>
                          )}
                    ...
                    uploadFile.map((fileItem, index) => {
                      return (
                        <TableRow key={index}>
                          ...
                          <TableCell>
                            {moment(fileItem.fileUploadedAt).format(
                              'MM/DD/YYYY'
                            )}
                          </TableCell>
                          <TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <>
                          ...
                          >
                            {t(
                              'componentData.USBankPrepaidCard.noFilesUploaded'
                            )}
                          </Typography>
                        </>
                      </TableCell>
